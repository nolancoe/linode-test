...
class Team(models.Model):
    ...
    owner = models.ForeignKey(Profile, on_delete=models.SET_NULL, related_name='owned_teams', null=True)
    players = models.ManyToManyField(Profile, related_name='members', blank=True)
...
class TeamInvitation(models.Model):
    ...
    inviting_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='sent_invitations')
    invited_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='received_invitations')
